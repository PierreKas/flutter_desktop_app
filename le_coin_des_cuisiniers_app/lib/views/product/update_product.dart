...
class _UpdateProductState extends State<UpdateProduct> {
  ...
  Product? productInfo;
  Future<Product?> getProductInfo(String prod_code) async {
    productInfo =
        await ProductController().getProductByCode(prod_code, context);
                                ...
                                return Theme(
                                  data: Theme.of(context).copyWith(
                                    colorScheme: const ColorScheme.light(
                                      primary: Color.fromARGB(255, 70, 103,
                                          71), // Header background color
                                      onPrimary:
